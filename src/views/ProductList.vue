...
<template>
    <div class="flex flex-col">
        <div class="card">
            <div class="font-semibold text-xl">Our Products</div>
            <DataView :value="products" paginator :rows="6" :sortOrder="sortOrder" :sortField="sortField"
                :layout="layout">
                <template #header>
                    <div class="flex justify-end">
                        <Select class="mr-3" v-model="sortKey" :options="sortOptions" optionLabel="label"
